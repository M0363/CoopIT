...
-(NSArray *)imagesFromMedia{
    if (self.media) {
        return [self imagesFromHTMLString:self.media];
    }
    return nil;
}
...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    if (self = [super init]) {
        ...
        _media = [aDecoder decodeObjectForKey:@"media:thumbnail"];
    }
    return self;
}
...
- (void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    [aCoder encodeObject:self.guid forKey:@"media:thumbnail"];
}
